...
.. input_param:: incflo.physics
   ...
   **type:** List of strings
   ...
   For immersed boundary forcing method, :ref:`TerrainDrag <inputs_terraindrag>` or :ref:`ChannelBuilder <inputs_ChannelBuilder>` can be used.
   For representing forested regions :ref:`ForestDrag <inputs_forest>` must be specified, which has two file-based approaches for parameterizing forest drag models.
