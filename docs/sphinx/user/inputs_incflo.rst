...
.. input_param:: incflo.physics
   ...
   **type:** List of strings
   ...
   among others. For multiphase simulations, the MultiPhase physics must be specified, and for forcing wave profiles into the domain, the OceanWaves physics must be specified as well.
